...
public class Compatability_1_12_R1 implements CompatabilityManager {
    ...
    public void sendJSONMessage(Player paramPlayer, String paramString) {
        ...
        PacketPlayOutChat localPacketPlayOutChat = new PacketPlayOutChat(localIChatBaseComponent1);
