...
public class Compatability_1_8_R1 implements CompatabilityManager {
    ...
    public void sendTitle(Player paramPlayer, String paramString) {
        ...
        PacketPlayOutTitle localPacketPlayOutTitle = new PacketPlayOutTitle(EnumTitleAction.TITLE, localIChatBaseComponent);
    ...
    public void sendSubtitle(Player paramPlayer, String paramString) {
        ...
        PacketPlayOutTitle localPacketPlayOutTitle = new PacketPlayOutTitle(EnumTitleAction.SUBTITLE, localIChatBaseComponent);
    ...
    public void sendJSONMessage(Player paramPlayer, String paramString) {
        ...
        IChatBaseComponent localIChatBaseComponent1 = ChatSerializer.a(arrayOfString[0]);
        if (arrayOfString.length > 1) {
            for (int i = 1; i < arrayOfString.length; i++) {
                IChatBaseComponent localIChatBaseComponent2 = ChatSerializer.a(arrayOfString[i]);
    ...
    public void sendJSONBroadcast(Collection<? extends Player> paramCollection, String paramString) {
        ...
        IChatBaseComponent localIChatBaseComponent = ChatSerializer.a(arrayOfString[0]);
        Object localObject;
        if (arrayOfString.length > 1) {
            for (int i = 1; i < arrayOfString.length; i++) {
                localObject = ChatSerializer.a(arrayOfString[i]);
